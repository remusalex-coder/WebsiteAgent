...
export const THEMES: Readonly<Record<DesignDirection, ThemeDefinition>> = {
  ...
  avantgarde: {
    id: 'avantgarde',
    description: 'Awwwards-grade editorial. Knockout display serif, mono body, extreme type contrast.',
    headingFont: { family: 'Instrument Serif', character: 'serif', fallback: 'serif', weights: [400, 500] },
    bodyFont: { family: 'Space Mono', character: 'mono', fallback: 'mono', weights: [400, 700] },
    monoFont: { family: 'JetBrains Mono', character: 'mono', fallback: 'mono', weights: [400, 700] },
    typeRatio: 1.7,
    baseRem: 1.0,
    measureCh: 60,
    displayTracking: -0.03,
    ...
    spacingRatio: 1.7,
    motion: 'expressive',
    motionEffects: ['fade', 'rise', 'stagger', 'parallax'],
    icons: 'line',
    imageTreatment: 'natural',
    heroPreference: ['full-bleed', 'editorial', 'magazine'],
    footer: 'rich',
    avoidVariants: ['timeline', 'carousel'],
    containerMaxRem: 78,
  },
};
